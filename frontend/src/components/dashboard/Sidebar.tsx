...
const menuItems = [
  ...
  { label: 'Đặt chỗ', icon: CalendarCheck, path: 'bookings', roles: ['manager'] },
  { label: 'Tòa nhà', icon: Building2, path: 'buildings', roles: ['admin', 'manager'] },
  { label: 'Tầng', icon: Layers3, path: 'floors', roles: ['admin', 'manager'] },
  { label: 'Dãy xe máy', icon: MapPinned, path: 'parking-rows', roles: ['manager'] },
  ...
  { label: 'Người dùng gói', icon: ScrollText, path: 'subscriptions', roles: ['manager'] },
  { label: 'Người dùng', icon: UsersRound, path: 'users', roles: ['admin'] },
  { label: 'Báo cáo', icon: BarChart3, path: 'reports', roles: ['admin', 'manager'] },
