...
const statusLabels: Record<ParkingSessionStatus, string> = {
  Parking: 'Đang đỗ',
  Completed: 'Hoàn tất',
  Overdue: 'Quá hạn',
};
...
export function RecentSessions({ sessions }: RecentSessionsProps) {
  return (
    ...
    >
      <div className="mb-5">
        <p className="text-sm font-medium text-slate-400">Phiên gửi xe gần đây</p>
        <h2 className="mt-1 text-xl font-bold tracking-tight text-white">Hoạt động gửi xe mới nhất</h2>
      </div>
        ...
        <table className="w-full min-w-[760px] text-left">
          <thead>
            <tr className="border-b border-white/10 text-xs uppercase tracking-[0.16em] text-slate-500">
              ...
              <th className="pb-3 font-semibold">Giờ ra</th>
              <th className="pb-3 font-semibold">Phí</th>
